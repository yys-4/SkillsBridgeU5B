      ...
      child: Container(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Container(
                // autogroupoq1y7b3 (DikEJXznfbsvE6B4xtoQ1y)
                ...
                child: Stack(
                  children: [
                    Positioned(
                      // terimakasihkamitelahmengirimka (80:3460)
                      left: 0*fem,
                      top: 178*fem,
                      child: Align(
                        child: SizedBox(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Container(
                                    ...
                                    height: 13.12*fem,
                                    child: Image.asset(
                                      'assets/user/images/signal-Lfw.png',
                                      width: 19.69*fem,
                                      height: 13.12*fem,
                                    ),
                                  ),
                                  Container(
                                    ...
                                    height: 13.12*fem,
                                    child: Image.asset(
                                      'assets/user/images/wi-fi-ca1.png',
                                      width: 18.59*fem,
                                      height: 13.12*fem,
                                    ),
                                  ),
                                  Container(
                                    ...
                                    height: 14.22*fem,
                                    child: Image.asset(
                                      'assets/user/images/battery-v2R.png',
                                      width: 29.97*fem,
                                      height: 14.22*fem,
                                    ),
                                  ),

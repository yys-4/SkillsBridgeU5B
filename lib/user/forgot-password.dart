            ...
            Positioned(
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      // autogroupe3vsfKT (DikBJCqbjAE9Pzhhm4e3vs)
                      ...
                      child: Stack(
                        children: [
                          ...
                          Positioned(
                            // enteryourusernameandemailaaq (80:3357)
                            left: 24*fem,
                            top: 164*fem,
                            child: Align(
                              child: SizedBox(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          height: 13.12*fem,
                                          child: Image.asset(
                                            'assets/user/images/signal-o3b.png',
                                            width: 19.69*fem,
                                            height: 13.12*fem,
                                          ),
                                        ),
                                        Container(
                                          ...
                                          height: 13.12*fem,
                                          child: Image.asset(
                                            'assets/user/images/wi-fi-QEH.png',
                                            width: 18.59*fem,
                                            height: 13.12*fem,
                                          ),
                                        ),
                                        Container(
                                          ...
                                          height: 14.22*fem,
                                          child: Image.asset(
                                            'assets/user/images/battery-v7X.png',
                                            width: 29.97*fem,
                                            height: 14.22*fem,
                                          ),
                                        ),
            ...
            Positioned(
              ...
              child: TextButton(
                ...
                child: Container(
                  ...
                  height: 320*fem,
                  child: Align(
                    // iconlylightarrowleft2eCd (1167:2175)
                    ...
                    child: SizedBox(
                      ...
                      child: Container(
                        ...
                        child: Image.asset(
                          'assets/user/images/iconly-light-arrow-left-2.png',
                          width: 7*fem,
                          height: 14*fem,
                        ),
                      ),

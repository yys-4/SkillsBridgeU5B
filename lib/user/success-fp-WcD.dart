  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Container(
        ...
        child: Container(
          // nyobaPAm (1318:1865)
          padding: EdgeInsets.fromLTRB(54*fem, 21*fem, 54*fem, 30*fem),
          width: 430*fem,
          height: 932*fem,
          decoration: BoxDecoration (
          ...
          child: Column(
            ...
            children: [
              Container(
                // autogroupakbzcpD (DinaxSda1znur3AUPgaKbZ)
                ...
                child: Stack(
                  children: [
                    Positioned(
                      // terimakasihkamitelahmengirimka (1318:1868)
                      left: 0*fem,
                      top: 178*fem,
                      child: Align(
                        child: SizedBox(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Container(
                                    ...
                                    height: 13.12*fem,
                                    child: Image.asset(
                                      'assets/user/images/signal-FoT.png',
                                      width: 19.69*fem,
                                      height: 13.12*fem,
                                    ),
                                  ),
                                  Container(
                                    ...
                                    height: 13.12*fem,
                                    child: Image.asset(
                                      'assets/user/images/wi-fi-FKK.png',
                                      width: 18.59*fem,
                                      height: 13.12*fem,
                                    ),
                                  ),
                                  Container(
                                    // batteryJ8d (1318:1876)
                                    width: 29.97*fem,
                                    height: 14.22*fem,
                                    child: Image.asset(
                                      'assets/user/images/battery-Ubf.png',
                                      width: 29.97*fem,
                                      height: 14.22*fem,
                                    ),
                                  ),
              ...
              Container(
                // rectangle24cf7 (I1318:1866;32:89)

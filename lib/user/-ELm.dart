                              ...
                              child: Row(
                                ...
                                children: [
                                  Container(
                                    ...
                                    height: 13.12*fem,
                                    child: Image.asset(
                                      'assets/user/images/signal-SBF.png',
                                      width: 19.69*fem,
                                      height: 13.12*fem,
                                    ),
                                  ),
                                  Container(
                                    ...
                                    height: 13.12*fem,
                                    child: Image.asset(
                                      'assets/user/images/wi-fi-ctV.png',
                                      width: 18.59*fem,
                                      height: 13.12*fem,
                                    ),
                                  ),
                                  Container(
                                    // battery61s (1366:5351)
                                    width: 29.97*fem,
                                    height: 14.22*fem,
                                    child: Image.asset(
                                      'assets/user/images/battery-dWV.png',
                                      width: 29.97*fem,
                                      height: 14.22*fem,
                                    ),
                                  ),
                ...
                child: ImageFiltered(
                  ...
                  child: Stack(
                    children: [
                      ...
                      Positioned(
                        // forgotthepassword1Rf (1366:5368)
                        left: 44*fem,
                        top: 215*fem,
                        child: Align(
                          child: SizedBox(

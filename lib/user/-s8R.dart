          ...
          children: [
            Positioned(
              ...
              child: Container(
                ...
                child: Align(
                  // wallpaperWWR (1366:5488)
                  alignment: Alignment.centerRight,
                  child: SizedBox(
                    width: 415*fem,
                    height: 893*fem,
                    child: Image.asset(
                      'assets/user/images/wallpaper-ZnD.png',
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                            ...
                            child: Row(
                              ...
                              children: [
                                Container(
                                  ...
                                  height: 13.12*fem,
                                  child: Image.asset(
                                    'assets/user/images/signal-opZ.png',
                                    width: 19.69*fem,
                                    height: 13.12*fem,
                                  ),
                                ),
                                Container(
                                  ...
                                  height: 13.12*fem,
                                  child: Image.asset(
                                    'assets/user/images/wi-fi-mfT.png',
                                    width: 18.59*fem,
                                    height: 13.12*fem,
                                  ),
                                ),
                                Container(
                                  // batteryinq (1366:5507)
                                  width: 29.97*fem,
                                  height: 14.22*fem,
                                  child: Image.asset(
                                    'assets/user/images/battery-ES9.png',
                                    width: 29.97*fem,
                                    height: 14.22*fem,
                                  ),
                                ),
                    ...
                    Container(
                      // masukkankodeverifikasiLZK (1366:5491)
                    ...
                    Container(
                      // kamimengirimpesankodeverifikas (1366:5492)
                    ...
                    Container(
                      // autogroup8drduF3 (DirP1CowQC2hSaXiUi8DRD)
                    ...
                    Container(
                      // autogroupn82pNJy (DirP9x4NCNdNjvnUQqn82P)
                    ...
                    Container(
                      // kirimulangkode0039zr9 (1366:5504)

      ...
      child: Container(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Container(
                // autogroupqsvbg1s (Dik9Jm9xR9Y13nYWEvQsvb)
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      // enteryourusernameandpasswordGn (80:3279)
                      left: 24*fem,
                      top: 164*fem,
                      child: Align(
                        child: SizedBox(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Container(
                                    ...
                                    height: 13.12*fem,
                                    child: Image.asset(
                                      'assets/user/images/signal-pZs.png',
                                      width: 19.69*fem,
                                      height: 13.12*fem,
                                    ),
                                  ),
                                  Container(
                                    ...
                                    height: 13.12*fem,
                                    child: Image.asset(
                                      'assets/user/images/wi-fi-gQu.png',
                                      width: 18.59*fem,
                                      height: 13.12*fem,
                                    ),
                                  ),
                                  Container(
                                    ...
                                    height: 14.22*fem,
                                    child: Image.asset(
                                      'assets/user/images/battery-PS5.png',
                                      width: 29.97*fem,
                                      height: 14.22*fem,
                                    ),
                                  ),

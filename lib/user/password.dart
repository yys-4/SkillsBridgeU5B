      ...
      child: Container(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Container(
                // autogroupaebuqdP (DikAKyxHBQxMuKdycnaebu)
                ...
                child: Stack(
                  children: [
                    ...
                    Positioned(
                      // enteryourusernameandpasswordDA (80:3316)
                      left: 24*fem,
                      top: 164*fem,
                      child: Align(
                        child: SizedBox(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Container(
                                    ...
                                    height: 13.12*fem,
                                    child: Image.asset(
                                      'assets/user/images/signal-y1F.png',
                                      width: 19.69*fem,
                                      height: 13.12*fem,
                                    ),
                                  ),
                                  Container(
                                    ...
                                    height: 13.12*fem,
                                    child: Image.asset(
                                      'assets/user/images/wi-fi-XGy.png',
                                      width: 18.59*fem,
                                      height: 13.12*fem,
                                    ),
                                  ),
                                  Container(
                                    ...
                                    height: 14.22*fem,
                                    child: Image.asset(
                                      'assets/user/images/battery-MVF.png',
                                      width: 29.97*fem,
                                      height: 14.22*fem,
                                    ),
                                  ),

        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
                      ...
                      child: Row(
                        ...
                        children: [
                          Container(
                            ...
                            height: 13.12*fem,
                            child: Image.asset(
                              'assets/user/images/signal-Vfj.png',
                              width: 19.69*fem,
                              height: 13.12*fem,
                            ),
                          ),
                          Container(
                            ...
                            height: 13.12*fem,
                            child: Image.asset(
                              'assets/user/images/wi-fi-2KP.png',
                              width: 18.59*fem,
                              height: 13.12*fem,
                            ),
                          ),
                          Container(
                            ...
                            height: 14.22*fem,
                            child: Image.asset(
                              'assets/user/images/battery-xSZ.png',
                              width: 29.97*fem,
                              height: 14.22*fem,
                            ),
                          ),
              ...
              Container(
                // casuallife3dsideviewofmansitti (72:607)
                margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 1.8*fem, 28.58*fem),
                width: 275*fem,
                height: 265.83*fem,
                child: Image.asset(
                  'assets/user/images/casual-life-3d-side-view-of-man-sitting-in-front-of-laptop-and-talking-on-phoneresult-1.png',
                  fit: BoxFit.cover,
                ),
              ),
              Container(
                // autogrouphs8jjbb (DijuSAGdALXfXf8pNnHS8j)
                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      height: 18.1*fem,
                      child: Image.asset(
                        'assets/user/images/ellipse-43.png',
                        width: 19*fem,
                        height: 18.1*fem,
                      ),
                    ),
                    ...
                    Container(
                      ...
                      height: 18.1*fem,
                      child: Image.asset(
                        'assets/user/images/ellipse-42.png',
                        width: 19*fem,
                        height: 18.1*fem,
                      ),
                    ),
                    ...
                    Container(
                      ...
                      height: 18.1*fem,
                      child: Image.asset(
                        'assets/user/images/ellipse-44-sZf.png',
                        width: 19*fem,
                        height: 18.1*fem,
                      ),
                    ),
                  ...
                  children: [
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            // skillbridgeusiapmembantumueVb (589:759)
                          ...
                          Container(
                            // kinisaatnyamemulaiproyekimpian (589:760)
                            constraints: BoxConstraints (
                              maxWidth: 277*fem,
                            ),
                            child: Text(
              ...
              Container(
                // rectangle24AVs (I933:1039;32:89)
